...
$(python3.4 -B $CONFIG/lib/python/apex-python-utils.py netenv-template -d $CONFIG -f network-environment.yaml.jinja2 --network-settings "$network_settings" -n "$enabled_network_list")
EOF
