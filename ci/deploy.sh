...
if [ -n "$DEPLOY_SETTINGS_FILE" ]; then
  ...
  openstack-config --set undercloud.conf DEFAULT local_ip ${deploy_deploy_options_instack_ip}/${deploy_deploy_options_provisioning_cidr##*/}
  openstack-config --set undercloud.conf DEFAULT network_gateway ${deploy_deploy_options_provisioning_gateway}
  openstack-config --set undercloud.conf DEFAULT network_cidr ${deploy_deploy_options_provisioning_cidr}
  openstack-config --set undercloud.conf DEFAULT dhcp_start ${deploy_deploy_options_provisioning_dhcp_start}
  openstack-config --set undercloud.conf DEFAULT dhcp_end ${deploy_deploy_options_provisioning_dhcp_end}
  openstack-config --set undercloud.conf DEFAULT inspection_iprange ${deploy_deploy_options_provisioning_inspection_iprange}
