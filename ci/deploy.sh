...
display_usage() {
  ...
  echo -e "   --use-existing-undercloud : If given it is assumed that a existing undercloud is available and only overcloud and post deployment is done"
}
  ...
  do
    case "$1" in
        ...
        --virtual-compute-ram )
                ...
                shift 2
            ;;
        --use-existing-undercloud )
                use_existing_undercloud="TRUE"
