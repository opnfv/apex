...
#TackerDeps
REQUIRED_PKGS=" python-sphinx python-heatclient python-neutronclient python-oslo-sphinx python-mistralclient python-ordereddict python-oslotest python-tackerclient python-tempest"
RELEASE_RPM=""
