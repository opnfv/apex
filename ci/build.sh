...
if ! rpm -q python-tosca-parser; then
    yum install -y http://artifacts.opnfv.org/apex/dependencies/python2-tosca-parser-0.7.0-1.el7.noarch.rpm
fi
if ! rpm -q python-heat-translator; then
    yum install -y http://artifacts.opnfv.org/apex/dependencies/python2-heat-translator-0.7.0-0.20170125154409.9620d09.el7.centos.noarch.rpm
fi
