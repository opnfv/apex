...
if __name__ == '__main__':
    ...
    if args.virtual:
        ...
        if deploy_settings['deploy_options']['sdn_controller'] == \
                'opendaylight' and args.virt_default_ram < 10240:
            control_ram = 10240
