...
if __name__ == '__main__':
    ...
    # Parse all settings
    deploy_settings = DeploySettings(args.file)
    net_settings = NetworkSettings(args.net_settings_file)
    ...
    if args.quickstart:
        ...
        deploy_quickstart(args, deploy_settings_file, args.net_settings_file,
                          inventory_file)
    else:
