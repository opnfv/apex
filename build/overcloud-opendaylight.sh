...
LIBGUESTFS_BACKEND=direct virt-customize \
    ...
    --upload ${BUILD_ROOT}/patches/honeycomb_vpp_mount_restart.patch:/usr/share/openstack-puppet/modules/fdio/ \
    --run-command "cd /usr/share/openstack-puppet/modules/fdio && patch -p1 <  honeycomb_vpp_mount_restart.patch" \
