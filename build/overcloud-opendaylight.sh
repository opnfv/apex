...
# Download ODL for fdio-dvr scenario
populate_cache http://artifacts.opnfv.org/apex/danube/fdio_dvr_odls/fdio_dvr_odl_master.tar.gz
...
LIBGUESTFS_BACKEND=direct virt-customize \
    ...
    --upload ${CACHE_DIR}/fdio_dvr_odl_master.tar.gz:/root/ \
