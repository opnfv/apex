...
LIBGUESTFS_BACKEND=direct virt-customize \
    ...
    --install https://github.com/oglok/networking-bgpvpn-rpm/blob/stable/newton/python2-networking-bgpvpn-5.0.1-dev6.noarch.rpm \
    --install https://github.com/oglok/networking-bgpvpn-rpm/blob/stable/newton/python-networking-bgpvpn-heat-5.0.1-dev6.noarch.rpm \
    --install https://github.com/oglok/networking-bgpvpn-rpm/blob/stable/newton/python-networking-bgpvpn-dashboard-5.0.1-dev6.noarch.rpm \
