...
LIBGUESTFS_BACKEND=direct virt-customize \
    ...
    --run-command "wget ${fdio_l2_uri_base}/opendaylight-6.0.0-0.1.20170222snap3974.el7.noarch.rpm -O /root/fdio_l2/opendaylight-6.0.0-0.1.20170222snap3974.el7.noarch.rpm" \
