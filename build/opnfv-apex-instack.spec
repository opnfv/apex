Name:		opnfv-apex-instack
Version:	2.0
Release:	%{release}
Summary:	Scripts and Disk images to launch Instack for OPNFV Apex

Group:		System Environment
License:	Apache 2.0
URL:		https://gerrit.opnfv.org/gerrit/apex.git
Source0:	opnfv-apex-instack.tar.gz
...
%description
Scripts and Disk images to launch Instack for OPNFV Apex
