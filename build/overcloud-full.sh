...
rm -rf puppet-fdio
git clone https://github.com/fepan/puppet-fdio -b vpp_binding_honeycomb
...
LIBGUESTFS_BACKEND=direct virt-customize \
    ...
    --upload ${BUILD_ROOT}/puppet-neutron/manifests/plugins/ml2/opendaylight.pp:/etc/puppet/modules/neutron/manifests/plugins/ml2/ \
