...
tar czf toscaparser.tar.gz toscaparser
...
LIBGUESTFS_BACKEND=direct virt-customize \
    ...
    --upload ${BUILD_DIR}/toscaparser.tar.gz/root/ \
    --run-command "cd /root/ && tar xzf toscaparser.tar.gz" \
    --run-command "cd /root/toscaparser && python setup.py build && python setup.py install" \
