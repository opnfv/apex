...
function barometer_pkgs {
  ...
  LIBGUESTFS_BACKEND=direct virt-customize \
    ...
    --install dejavu-sans-mono-fonts,libstatgrab,log4cplus,rrdtool,rrdtool-devel \
    --install mcelog,python34,python34-libs,python34-devel \
    --install python-rpm-macros,python-srpm-macros,python3-rpm-macros,libvirt,libvirt-devel,gcc \
    -a $OVERCLOUD_IMAGE
