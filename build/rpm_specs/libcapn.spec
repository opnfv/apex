...
install %{_builddir}/%{name}-%{version}/libcapn.so.1.0.0 %{buildroot}/%{_libdir}/libcapn.so.1
install %{_builddir}/%{name}-%{version}/libcapn.so.1.0.0 %{buildroot}/%{_libdir}/libcapn.so
