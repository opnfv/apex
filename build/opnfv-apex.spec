...
cp build/instackenv.json %{buildroot}%{_var}/opt/opnfv/
...
cp build/stack/overcloud-full.initrd overcloud-full.qcow2 %{buildroot}%{_var}/opt/opnfv/stack/
...
%{_var}/opt/instackenv.json
%{_var}/opt/stack/deploy-ramdisk-ironic.initramfs
%{_var}/opt/stack/deploy-ramdisk-ironic.kernel
#/opt/stack/ironic-python-agent.initramfs
#/opt/stack/ironic-python-agent.kernel
#/opt/stack/ironic-python-agent.vmlinuz
%{_var}/opt/stack/overcloud-full.initrd overcloud-full.qcow2
%{_var}/opt/stack/overcloud-full.vmlinuz
%{_var}/opt/stack/fedora-user.qcow2
