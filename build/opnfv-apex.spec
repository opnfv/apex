...
%build
rst2html docs/src/installation-instructions.rst docs/installation-instructions.html
...
mkdir -p %{buildroot}/usr/share/docs/opnfv/
install LICENCE %{buildroot}/usr/share/docs/opnfv/
install docs/src/installation-instructions.rst %{buildroot}/usr/share/docs/opnfv/
install docs/installation-instructions.html %{buildroot}/usr/share/docs/opnfv/
...
%doc /usr/share/docs/opnfv/LICENSE
%doc /usr/share/docs/opnfv/installation-instructions.rst
%doc /usr/share/docs/opnfv/installation-instructions.html
