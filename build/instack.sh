...
if [ ! -f ${rdo_images_uri}/opendaylight-4.0.0-1.rc1.el7.noarch.rpm ]; then
    opendaylight=opendaylight
else
    opendaylight=http://cbs.centos.org/repos/nfv7-opendaylight-4-testing/x86_64/os/Packages/opendaylight-4.0.0-1.rc1.el7.noarch.rpm
fi
...
if [ ! -f ${rdo_images_uri}/puppet-opendaylight-3.0.1.tar.gz ]; then
    ...
    cp ${rdo_images_uri}/puppet-opendaylight.tar.gz puppet-opendaylight.tar.gz
fi
