...
pushd files
wget http://205.177.226.237:9999/onosfw/jdk-8u51-linux-x64.tar.gz
wget http://205.177.226.237:9999/onosfw/onos-1.3.0.tar.gz
wget http://205.177.226.237:9999/onosfw/repository.tar
popd
