...
LIBGUESTFS_BACKEND=direct virt-customize \
    ...
    --run-command "sed -i 's/  \$enable_isolated_metadata = false,/\\c  \$enable_isolated_metadata = true,'/etc/puppet/modules/neutron/manifests" \
    --run-command "sed -i 's/  \$enable_metadata_network = false,/\\c  \$enable_metadata_network = true,'/etc/puppet/modules/neutron/manifests" \
