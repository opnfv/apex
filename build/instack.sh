...
LIBGUESTFS_BACKEND=direct virt-customize \
    --upload  upload -<<_end_ /etc/yum.repos.d/opendaylight.repo
[opendaylight]
name=OpenDaylight $releasever - $basearch
baseurl=http://cbs.centos.org/repos/nfv7-opendaylight-33-release/$basearch/os/
enabled=1
...
LIBGUESTFS_BACKEND=direct virt-customize --install http://mirrors.neterra.net/elrepo/kernel/el6/x86_64/RPMS/kernel-ml-devel-3.13.7-1.el6.elrepo.x86_64.rpm \
                                         --upload  upload -<<_end_ /etc/yum.repos.d/opendaylight.repo
[opendaylight]
name=OpenDaylight \$releasever - \$basearch
