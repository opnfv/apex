...
install config/deploy/os-odl_l2-vpp-ha.yaml %{buildroot}%{_sysconfdir}/opnfv-apex/os-odl_l2-vpp-ha.yaml
install config/deploy/os-odl_l2-vpp-noha.yaml %{buildroot}%{_sysconfdir}/opnfv-apex/os-odl_l2-vpp-noha.yaml
...
%{_sysconfdir}/opnfv-apex/os-odl_l2-vpp-noha.yaml
%{_sysconfdir}/opnfv-apex/os-odl_l2-vpp-ha.yaml
...
%changelog
* Thu Jun 15 2016 Tim Rozet <trozet@redhat.com> - 3.0-8
- Add vpp scenarios.
