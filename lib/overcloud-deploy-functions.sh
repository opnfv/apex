...
sed -i 's#^.*ControllerExtraConfigPre.*#  OS::TripleO::ControllerExtraConfigPre: /usr/share/openstack-tripleo-heat-templates/puppet/extraconfig/pre_deploy/controller/numa.yaml#' network-environment.yaml
EOI
