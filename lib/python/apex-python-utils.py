...
def build_netenv_template(args):
    ...
    netenv['parameter_defaults']['ExternalNetCidr'] = settings.public_network.cidr
    ...
    if settings.PRIVATE_NETWORK in args.enabled_networks:
        ...
        netenv['parameter_defaults']['TenantNetCidr'] = settings.private_network.cidr
    ...
    if settings.STORAGE_NETWORK in args.enabled_networks:
        # resource registry updates
        ...
        # default parameter updates
        netenv['parameter_defaults']['StorageNetCidr'] = settings.storage_network.cidr
    ...
    if settings.API_NETWORK in args.enabled_networks:
