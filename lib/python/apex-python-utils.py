...
def build_nic_template(args):
    ...
    print(template.render(
              ...
              role=args.role,
              private_vlan=settings[constants.PRIVATE_NETWORK]['vlan'],
              storage_vlan=settings[constants.STORAGE_NETWORK]['vlan'],
              public_vlan=settings[constants.PUBLIC_NETWORK]['vlan'],
