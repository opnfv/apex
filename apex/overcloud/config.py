...
from apex.deploy import ApexDeployException
...
def create_nic_template(network_settings, deploy_settings, role, template_dir,
    ...
    template_file = os.path.join(template_dir, 'nics-template.yaml.jinja2')
    ...
    if ds['dataplane'] == 'fdio':
        ...
        nets['external'][0]['nic_mapping'][role]['phys_type'] = 'vpp_interface'
