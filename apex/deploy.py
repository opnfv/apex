...
def main():
    ...
    if args.quickstart:
        ...
        try:
            ...
            os.remove(os.path.join(APEX_TEMP_DIR, SDN_IMAGE))
        except Exception:
        ...
        deploy_vars['SSH_OPTIONS'] = '-o StrictHostKeyChecking=no -o ' \
                                     ...
                                     'LogLevel=error'
        deploy_vars['external_network_cmds'] = deploy.external_network_cmds(
            net_settings)
        ...
        deploy_vars['congress_datasources'] = deploy.create_congress_cmds(
            overcloudrc)
